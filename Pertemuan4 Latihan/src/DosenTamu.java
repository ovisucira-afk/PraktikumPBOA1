...
public class DosenTamu extends Dosen { 
    ...
    public  void setTglAkhirKontrak(LocalDate tanggalAkhirKontrak){
        this.tanggalAkhirKontrak = tanggalAkhirKontrak;
    }
    ...
    public long sisaKontrak(){
        LocalDate sekarang = LocalDate.of(2026,3,11);
        return ChronoUnit.MONTHS.between(sekarang,tanggalAkhirKontrak);
    }

    // mencetak nip, nama, tanggalLahir, tmt, gajiPokok, nidk, jabatan, fakultas, tanggalAkhirKontrak, sisaKontrak, dan tunjangan
    @Override
